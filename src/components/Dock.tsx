...
const DOCK_ITEMS: Array<{ id: AppType; label: string; icon: string }> = [
  { id: "about", label: "О продукте", icon: "Info" },
  { id: "resume", label: "Загрузки", icon: "Download" },
  { id: "writings", label: "Возможности", icon: "Zap" },
  { id: "art", label: "Скриншоты", icon: "MonitorSmartphone" },
]
